import { OrganizationProfile, IndustryType } from '../types/organization';
import { SecurityAsset, Vulnerability, SecurityControlStatus, IncidentAlert } from '../types/security';
import { SecurityAction } from '../types/investment';

export const INDUSTRY_PRESETS: Record<IndustryType, OrganizationProfile> = {
  BANKING_FINTECH: {
    id: 'org-fintech-01',
...
export const INITIAL_ASSETS: Record<IndustryType, SecurityAsset[]> = {
  BANKING_FINTECH: [
    {
      id: 'ast-bnk-01',
...
export const INITIAL_CONTROLS: SecurityControlStatus[] = [
  {
    id: 'ctrl-01',
...
export const SECURITY_ACTIONS_CATALOG: SecurityAction[] = [
  {
    id: 'act-patch-rce',
